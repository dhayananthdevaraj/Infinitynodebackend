      ...
      >
        <div className="col-md-8">
          <div className=" mb-4 mx-5">
            <h1 className="fs-24 mb-3">Choose your payment method</h1>
                ...
                <ul class="nav nav-pills navtabs" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    ...
                    >
                      <div>
                        <img
                          src={activeTab === "tab2" ? UPIIcon : inActiveUPIIcon}
                          alt="UPIIcon"
                        />
                      </div>
                      <div class="text-dark mt-2">UPI</div>
                    </a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a
                    ...
                    >
                      <div>
                        <img
                          src={
                            activeTab === "tab3" ? cashIcon : inActivecashIcon
                          }
                          alt="cashIcon"
                        />
                      </div>
                      <div>
                        <div class="text-dark mt-2 ms-3">Cash</div>
                      </div>
                    </a>
                  </li>
                  <li class="nav-item" role="presentation">
